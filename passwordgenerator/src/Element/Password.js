 ...
 // copy to clipboard
   ...
   return (
     <div className=" flex flex-col font-serif ">
       <label className="m-5 bg-red-300 p-3 rounded-md">
         Length of Password :
         <input
       ...
       <div className="flex justify-center items-center">
         <button
           className="p-4 bg-gray-600 m-4 rounded-lg  hover:bg-green-300 hover:text-black"
       ...
       <CopyToClipboard text={password}>
         <button className="p-3 bg-green-300 text-red-700 font-bold my-4 rounded-md">Copy to clipboard</button>
       </CopyToClipboard>
     </div>
   );
 };
